...
public class ServerInterface extends FreedomService
{
    ...
    public ServerInterface(OrangeFreedomMod plugin)
    {
        super(plugin);
    }
    ...
    public static void warnVersion()
    {
        ...
        {
            FLog.warning(OrangeFreedomMod.pluginName + " is compiled for " + COMPILE_NMS_VERSION + " but the server is running version " + nms + "!");
