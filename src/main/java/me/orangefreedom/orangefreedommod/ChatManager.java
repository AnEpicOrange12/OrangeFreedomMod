...
import me.orangefreedom.orangefreedommod.util.FSync;
import static me.orangefreedom.orangefreedommod.util.FUtil.playerMsg;
...
public class ChatManager extends FreedomService
{
    ...
    public ChatManager(OrangeFreedomMod plugin)
    {
        super(plugin);
    }
