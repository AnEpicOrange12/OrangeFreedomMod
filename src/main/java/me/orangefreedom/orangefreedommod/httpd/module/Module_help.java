...
import static me.orangefreedom.orangefreedommod.httpd.HTMLGenerationTools.heading;
...
import me.orangefreedom.orangefreedommod.rank.Displayable;
...
public class Module_help extends HTTPDModule
{
    ...
    public Module_help(OrangeFreedomMod plugin, NanoHTTPD.HTTPSession session)
    {
    ...
    public String getBody()
    {
        ...
        while (it.hasNext())
        {
            ...
            {
                if (!OrangeFreedomMod.pluginName.equals(pluginName))
                {
