...
import me.orangefreedom.orangefreedommod.httpd.HTMLGenerationTools;
...
public class Module_schematic extends HTTPDModule
{
    ...
    public Module_schematic(OrangeFreedomMod plugin, NanoHTTPD.HTTPSession session)
    {
    ...
    public String title()
    {
        return "OrangeFreedomMod :: Schematic Manager";
    }
