package me.orangefreedom.orangefreedommod.bridge;
...
public class WorldEditListener extends PluginListener<OrangeFreedomMod>
{

    public WorldEditListener(OrangeFreedomMod plugin)
    {
        super(plugin);
    }
