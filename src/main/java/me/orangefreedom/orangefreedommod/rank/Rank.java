...
public enum Rank implements Displayable
{
    ...
    GENERAL_ADMIN("a", "General Admin", Type.ADMIN, "GA", ChatColor.GRAY),
    ORANGE_ADMIN("a", "Orange Admin", Type.ADMIN, "OA", ChatColor.DARK_PURPLE),
    TCA("a", "Telnet Clan Admin", Type.ADMIN, "TCA", ChatColor.GREEN),
    SPECIALIST("a", "Specialist Admin", Type.ADMIN, "Spec", ChatColor.GRAY),
    SYSTEM_ADMIN("a", "System Admin", Type.ADMIN, "SysA", ChatColor.DARK_RED),
    ...
    SYSTEM_CONSOLE("the", "System Console", Type.ADMIN_CONSOLE, "System Console", ChatColor.DARK_PURPLE),
