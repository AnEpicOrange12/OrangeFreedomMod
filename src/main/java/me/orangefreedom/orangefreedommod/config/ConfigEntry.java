package me.orangefreedom.orangefreedommod.config;
...
public enum ConfigEntry
{
    ...
    SERVER_MASTERARCHITECT(List.class, "server.masterarchitects"),
    SERVER_DISCORDADMIN(List.class, "server.discordadmins"),
    SERVER_FORUMADMIN(List.class, "server.forumadmins"),
    ...
    {
        return OrangeFreedomMod.plugin().config;
    }
