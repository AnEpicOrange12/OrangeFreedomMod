...
public class MainConfig extends PluginComponent<OrangeFreedomMod>
{
    ...
    public MainConfig(OrangeFreedomMod plugin)
    {
        super(plugin);
    ...
    {
        return plugin.getResource(OrangeFreedomMod.CONFIG_FILENAME);
    }
