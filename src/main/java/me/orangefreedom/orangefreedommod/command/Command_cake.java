...
public class Command_cake extends FreedomCommand
{
    ...
    public static final String CAKE_LYRICS = "To all people with orange power! Here is a cake! Try it! Its Delicious";
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        heldItemMeta.setDisplayName((new StringBuilder()).append(ChatColor.WHITE).append("The Dicty ").append(ChatColor.DARK_GRAY).append("Cake").toString());
