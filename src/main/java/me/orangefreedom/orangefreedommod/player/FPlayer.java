package me.orangefreedom.orangefreedommod.player;
...
import me.orangefreedom.orangefreedommod.caging.CageData;
import me.orangefreedom.orangefreedommod.config.ConfigEntry;
import me.orangefreedom.orangefreedommod.freeze.FreezeData;
...
public class FPlayer
{
    ...
    @Getter
    private final OrangeFreedomMod plugin;
    @Getter
    ...
    public FPlayer(OrangeFreedomMod plugin, Player player)
    {
        this(plugin, player.getName(), Ips.getIp(player));
    }

    private FPlayer(OrangeFreedomMod plugin, String name, String ip)
    {
        this.plugin = plugin;
        this.name = name;
        this.ip = ip;
    ...
    public void startArrowShooter(OrangeFreedomMod plugin)
    {
