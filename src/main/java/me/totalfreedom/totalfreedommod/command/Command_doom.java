...
@CommandPermissions(level = Rank.EXECUTIVE, source = SourceType.ONLY_CONSOLE, blockHostConsole = true)
...
public class Command_doom extends FreedomCommand
{
    ...
    public boolean run(final CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (admin != null)
        {
            FUtil.adminAction(sender.getName(), "Removing " + player.getName() + " from the orange crew", true);
        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                ...
                // kick player
                player.kickPlayer(ChatColor.RED + "HOW DARE YOU BREAK THE RULES! YOU ARE THE WORST ADMIN EVER. BE VANISHED FROM THE ORANGE CREW!!!!");
            }
