    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        switch (args[0])
        {
            ...
            case "add":
            {
                ...
                {
                    msg("That player is already part of the orange crew.");
                    return true;
                }
                ...
                if (admin == null) // New admin
                {
                    ...
                    FUtil.adminAction(sender.getName(), "Adding " + player.getName() + " to the orange crew", true);
                    plugin.al.addAdmin(new Admin(player));
                }
                else // Existing admin
                {
                    FUtil.adminAction(sender.getName(), "Readding " + admin.getName() + " to the orange crew", true);
            ...
            case "remove":
            {
                ...
                if (admin == null)
                {
                    msg("Admins not found: " + args[1]);
                    return true;
                }

                FUtil.adminAction(sender.getName(), "Removing " + admin.getName() + " from the orange crew", true);
